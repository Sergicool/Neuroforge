...
\subsection*{Interfaz de partida}
...
% ─────────────────────────────────────────────────────────────────────────────
\section{Iteración 3: Mejoras audiovisuales}
% ─────────────────────────────────────────────────────────────────────────────
...
Finalmente, se incluyeron fondos coherentes entre el menú principal y la escena de la partida para unificar la estética y evitar que el transcurso de la partida se sintiera visualmente vacío. A estos fondos se les aplicó un ligero efecto de \textit{parallax}, lo que aporta profundidad y una mayor sensación de pulido a la experiencia.

% ─────────────────────────────────────────────────────────────────────────────
\section{Iteración 4: Implementación del bot inteligente}
% ─────────────────────────────────────────────────────────────────────────────

La cuarta iteración se dedicó al desarrollo del sistema de inteligencia artificial. El trabajo se realizó en Python utilizando la biblioteca \textit{Gymnasium} para crear el entorno de juego y el algoritmo \textit{MaskablePPO} para el entrenamiento.
