...
\begin{table}[H]
	...
	\begin{tabular}{|c|l|l|}
		...
		\hline
		& Iteración 1: Videojuego base & Núcleo jugable mínimo y lógicas de tablero \\ \cline{2-3}
		& Iteración 2: Interfaz de usuario & Interfaz, menús y flujo de navegación visual \\ \cline{2-3}
		& Iteración 3: Mejoras audiovisuales & Sonido, música y ambientación del entorno \\ \cline{2-3}
		\multirow{-4}{*}{Construcción} & Iteración 4: Bot inteligente & Implementación y entrenamiento de la IA \\
		\hline
