...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.45\linewidth]{../Imagenes/Metodologia}
...
\begin{table}[H]
	...
	\begin{tabular}{|c|l|c|c|}
		...
		\hline
		1 & Juego base & 2026-02-26 & 2026-03-19 \\
		\hline
...
El coste de personal es el factor dominante en cualquier proyecto de desarrollo de software. Para estimarlo se toma como referencia el salario mensual bruto de un desarrollador junior de videojuegos en España, situado en 
aproximadamente \textbf{2.333~€ brutos/mes} (28.000~€ anuales según datos de Glassdoor~\cite{glassdoor_gamedeveloper}). Dado que la dedicación total del proyecto ha sido de \textbf{300~horas} y que una jornada laboral estándar supone unas 160~horas mensuales, la duración equivalente es de \textbf{1,875~meses}, lo que da un coste salarial bruto de \textbf{4.125,00~€}. Este es el coste en el escenario individual, lo que percibiría el profesional por su trabajo.
...
El canal de distribución natural para un videojuego independiente en PC es \textbf{Steam}. A fecha de redacción de este documento, publicar en la plataforma conlleva una tasa de registro de \textbf{84,99~€} por título~\cite{steam_pricing}, reembolsable una vez el juego acumula 1.000~USD en ventas (aproximadamente \textbf{849,99~€} al cambio actual). Además, Steam retiene una comisión del \textbf{30\,\%} sobre cada venta.

Fijar el precio requiere equilibrar la percepción de calidad y el volumen de ventas esperado. Un precio inferior a 1~€ tiende a generar en el consumidor la percepción de que el producto carece de valor, mientras que superar los 2--3~€ resulta difícil de justificar para un título de estas características. Se establece por tanto un \textbf{precio de venta de 1,99~€}, coherente con la escala del proyecto y habitual en el catálogo de juegos independientes de calidad modesta en Steam. Descontada la comisión de la plataforma, el ingreso neto por copia vendida es de \textbf{1,39~€}.
