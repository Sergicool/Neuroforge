...
El botón \textit{Random Placement} (\textbf{6}) distribuye automáticamente todas las piezas restantes en posiciones aleatorias dentro de la zona de despliegue. Una vez colocadas todas las piezas, el botón \textit{Start Battle} (\textbf{7}) se activa y al pulsarlo el bot despliega sus piezas en su zona (\textbf{8}) y comienza la partida.
