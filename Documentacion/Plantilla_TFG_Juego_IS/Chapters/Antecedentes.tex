...
Los primeros motores reutilizables surgieron en la década de 1990 a raíz del éxito de títulos como \textit{Doom} (id Software, 1993), cuyo motor fue licenciado a terceros y sentó las bases del concepto moderno de motor de videojuegos \cite{Kushner2003}. A partir de entonces, la industria evolucionó hacia soluciones cada vez más genéricas y accesibles. \textit{Unreal Engine}, lanzado por Epic Games en 1998, y \textit{Unity}, publicado en 2005, se consolidaron como los dos referentes dominantes del sector. Unreal Engine destaca por su capacidad para generar entornos tridimensionales de alta fidelidad visual y es ampliamente utilizado en producciones de gran presupuesto. Unity, por su parte, ofrece mayor versatilidad para proyectos de tamaño medio y tiene una presencia especialmente destacada en el desarrollo de videojuegos independientes y móviles. Ambos motores, sin embargo, están sujetos a licencias comerciales que pueden resultar restrictivas en contextos académicos o independientes.
