...
{
    private static readonly Texture2D BLUE_TILE  = GD.Load<Texture2D>("res://entities/tile/BlueTile.png");
    private static readonly Texture2D GREY_TILE  = GD.Load<Texture2D>("res://entities/tile/GreyTile.png");
    private static readonly Texture2D GREEN_TILE = GD.Load<Texture2D>("res://entities/tile/GreenTile.png");
    private static readonly Texture2D RED_TILE   = GD.Load<Texture2D>("res://entities/tile/RedTile.png");
