...
{
    [Export] private PackedScene BOARD_SCENE;
    ...
    {
        _turnIcon.Texture = turn == PieceOwner.PLAYER ? PLAYER_ICON : BOT_ICON;
    ...
    private async Task BlinkTurnIcon(PieceOwner newTurn)
    {
        ...
        Texture2D newTexture = newTurn == PieceOwner.PLAYER ? PLAYER_ICON : BOT_ICON;
    ...
    {
        _board = BOARD_SCENE.Instantiate<Board>();
        AddChild(_board);
